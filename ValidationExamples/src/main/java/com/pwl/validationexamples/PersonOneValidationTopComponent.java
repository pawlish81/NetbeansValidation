 ...
 */
@ConvertAsProperties(
        dtd = "-//com.pwl.validationexamples//PersonOneValidation//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "PersonOneValidationTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "editor", openAtStartup = true)
@ActionID(category = "Window", id = "com.pwl.validationexamples.PersonOneValidationTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_PersonOneValidationAction",
        preferredID = "PersonOneValidationTopComponent"
)
@Messages({
    "CTL_PersonOneValidationAction=PersonOneValidation",
    "CTL_PersonOneValidationTopComponent=PersonOneValidation Window",
    "HINT_PersonOneValidationTopComponent=This is a PersonOneValidation window"
})
@SuppressWarnings("serial")
public final class PersonOneValidationTopComponent extends TopComponent {

    public PersonOneValidationTopComponent() {
        initComponents();
        setName(Bundle.CTL_PersonOneValidationTopComponent());
        setToolTipText(Bundle.HINT_PersonOneValidationTopComponent());
    ...
    private void initComponents() {
        ...
        nameTextField.setText(org.openide.util.NbBundle.getMessage(PersonOneValidationTopComponent.class, "PersonOneValidationTopComponent.Name Field.text")); // NOI18N
        nameTextField.setName("Name Field"); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(nameLabel, org.openide.util.NbBundle.getMessage(PersonOneValidationTopComponent.class, "PersonOneValidationTopComponent.nameLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(okButton, org.openide.util.NbBundle.getMessage(PersonOneValidationTopComponent.class, "PersonOneValidationTopComponent.okButton.text")); // NOI18N
        okButton.setEnabled(false);

        surnameTextField.setText(org.openide.util.NbBundle.getMessage(PersonOneValidationTopComponent.class, "PersonOneValidationTopComponent.surnameTextField.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(surnameLabel, org.openide.util.NbBundle.getMessage(PersonOneValidationTopComponent.class, "PersonOneValidationTopComponent.surnameLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(resultText, org.openide.util.NbBundle.getMessage(PersonOneValidationTopComponent.class, "PersonOneValidationTopComponent.resultText.text")); // NOI18N
